...
entity_ids: [ent_statelessness]
claim_ids: [clm_688a5a02a006, clm_70000f81f953, clm_11e28d02ab4f]
confidence: 0.83
...
> **In here:** There is no such thing as a stateful LLM by itself: every stateful LLM system is built around a stateless model call, which is the constraint every wiki builder is working inside · 3 claims, confidence 0.83.
...
- ← applies_to [[cache-rewarming]] (0.80)
- → applies_to [[context-window]] (0.80)
- → applies_to [[llm-wiki]] (0.80)

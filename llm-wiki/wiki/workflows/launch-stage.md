...
entity_ids: [ent_launch_stage]
claim_ids: [clm_0e2fbb6703af, clm_74747bbbbb79]
confidence: 0.83
...
> **In here:** The founder being in every loop is an asset at MVP and the constraint at Launch, and the transition from doing the work to designing the systems that do the work is one of the hardest shifts in the… · 2 claims, confidence 0.83.
...
- → extends [[mvp-stage]] (0.84)
- ← related_to [[founder]] (0.84)

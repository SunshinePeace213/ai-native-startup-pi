...
- A deep link's q parameter carries the URL-encoded text to pre-fill in the prompt box, uses %0A for line breaks, and is capped at 5,000 characters (0.91)
- A deep link sets its working directory with either cwd or repo, and when both are passed cwd takes precedence and repo is ignored even if the cwd path does not exist (0.91)
...
- `clm_5d4da4170187` — "A deep link's q parameter carries the URL-encoded text to pre-fill in the prompt box, uses %0A for line breaks, and is capped at 5,000 characters." · p 0.91 · active · 1 support · 0 contradict
...
- `clm_6b48da9eac6c` — "A deep link sets its working directory with either cwd or repo, and when both are passed cwd takes precedence and repo is ignored even if the cwd path does not exist." · p 0.91 · active · 1 support · 0 contradict

...
author: Anthropic
---
> **In here:** measuring latency (baseline latency, time to first token) · reducing latency by model choice, prompt/output length, and temperature · streaming responses for perceived responsiveness

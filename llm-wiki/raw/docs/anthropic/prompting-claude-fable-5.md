...
author: Anthropic
---
> **In here:** Claude Fable 5 behavioral differences from Opus 4.8 · prompting patterns for long runs, effort, instruction following, memory · scaffolding changes and a send-to-user tool spec.

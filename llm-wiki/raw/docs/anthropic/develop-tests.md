...
author: Anthropic
---
> **In here:** defining specific, measurable, achievable, relevant success criteria · building code-graded, human-graded, and LLM-graded evaluations · grading rubrics, ranking outputs, and structuring evaluation data at scale
...
![Flowchart of prompt engineering: test cases, preliminary prompt, iterative testing and refinement, final validation, ship](../../assets/docs/anthropic/prompt-engineering-flowchart.png)

...
author: Anthropic
---
> **In here:** effort-level and progress-update guidance for Claude Fable 5.1 · agentic behavior (tool batching, subagents, scope discipline) and safeguard/format prompting patterns · migration notes and instruction snippets vs Claude Fable 5

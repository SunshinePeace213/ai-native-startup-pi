...
fetched: 2026-09-13
---
> **In here:** per-model token pricing and cache multipliers · cloud platform / AWS / Azure Marketplace billing (CCUs) · feature pricing (caching, batch, tools, fast mode, Managed Agents)

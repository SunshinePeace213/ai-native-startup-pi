...
author: Anthropic
---
> **In here:** basic strategies (allow "I don't know", quote-grounding, citation verification) · advanced techniques (chain-of-thought, best-of-N, iterative refinement, external-knowledge restriction) · caveat that hallucinations are reduced, not eliminated

...
author: Anthropic
---
> **In here:** Claude Opus 5 behavioral changes (verbosity, narration, self-verification, subagent delegation) · concrete prompt snippets to tune each · thinking-disabled artifacts and mitigations

...
author: Anthropic
---
> **In here:** jailbreak/direct prompt injection mitigations (harmlessness screens, input validation, hardened system prompts) · indirect prompt injection defenses for untrusted tool content (JSON-encoding, screening, least privilege) · continuous monitoring and layered/chained safeguards example

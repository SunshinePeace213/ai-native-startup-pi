...
fetched: 2026-08-23
---
> **In here:** `--worktree` flag and isolation checks · subagent worktree isolation and cleanup sweeps · customization (base branch, PR checkout, worktreeinclude) and troubleshooting

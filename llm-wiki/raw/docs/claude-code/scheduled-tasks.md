...
author: Anthropic
---
> **In here:** `/loop` prompt scheduling vs. Cloud/Desktop options · CronCreate/CronList/CronDelete tool reference · jitter, seven-day expiry, and cron expression syntax

...
author: Anthropic
---
> **In here:** installing and managing MCP servers (HTTP, SSE, stdio, WebSocket) · scopes, status, and dynamic tool updates · MCP prompts as commands and managed configuration

...
author: Anthropic
---
> **In here:** built-in subagents (Explore, Plan, general-purpose) · configuring custom subagents (frontmatter, tools, model, scope) · what loads at startup, plus a hook example restricting subagent tool use

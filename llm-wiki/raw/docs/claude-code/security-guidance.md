...
author: Anthropic
---
> **In here:** security-guidance plugin install and prerequisites · per-edit, end-of-turn, and commit review layers · custom rules, disabling layers, and how it fits with other security tools

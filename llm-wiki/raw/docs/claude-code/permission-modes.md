...
fetched: 2026-08-23
author: Claude Code Docs (Anthropic)
---
> **In here:** Permission mode table (default, plan, acceptEdits, bypassPermissions) · auto mode classifier behavior · switching modes via CLI/VS Code/Desktop/settings

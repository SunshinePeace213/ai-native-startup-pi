...
author: Anthropic
---
> **In here:** quick vs manual GitHub App setup and secrets · workflow YAML examples (mention, automation, review) · configuration reference and GitHub App permissions

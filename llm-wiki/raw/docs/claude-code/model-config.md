...
author: Anthropic
---
> **In here:** model aliases & versions per provider · setting/pinning models (CLI, env vars, settings, modelOverrides) · effort levels, extended thinking, extended context, prompt caching config

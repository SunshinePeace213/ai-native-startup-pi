...
fetched: 2026-08-23
---
> **In here:** sending/receiving messages between Claude Code sessions (`ListAgents`/`SendMessage`) · inbound controls, permission-mode defaults, and cross-machine delivery · limits, availability, and restricting/turning off messaging

...
author: Anthropic
---
> **In here:** built-in tool catalog with permission requirements · per-tool behavior (Bash, Read, Edit, Write, WebFetch, WebSearch, etc.) · how to configure and inspect tool access

...
author: Anthropic
---
> **In here:** installing and running the Claude Security plugin · scanning a codebase, changes, or a diff, and reading results · turning findings into reviewed patches

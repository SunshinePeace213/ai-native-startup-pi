...
author: Anthropic
---
> **In here:** Scoping Claude Code to monorepos with per-directory CLAUDE.md and skills · limiting file reads via deny rules and code intelligence · sparse worktrees and cross-package change planning.

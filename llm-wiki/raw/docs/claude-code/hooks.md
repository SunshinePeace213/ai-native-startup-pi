...
author: Anthropic
---
> **In here:** hook events and lifecycle · configuration schema, JSON input/output, exit codes · async/HTTP/prompt/MCP tool hooks

...
---
> **In here:** SKILL.md frontmatter fields and constraints · directory structure and optional folders (scripts/references/assets) · progressive disclosure and validation

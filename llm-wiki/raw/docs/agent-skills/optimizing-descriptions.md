...
---
> **In here:** how skill triggering works via description matching · designing train/validation eval query sets · the description optimization loop and worked example

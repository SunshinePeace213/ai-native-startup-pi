...
---
> **In here:** roster of agent products supporting the Agent Skills format · per-client setup-instructions and source-code links · client showcase React/JSX component source

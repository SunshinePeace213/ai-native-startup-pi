...
---
> **In here:** grounding skills in real expertise and execution traces · spending context wisely (progressive disclosure, scoping) · calibrating instruction specificity and reusable content patterns (gotchas, templates, checklists, validation loops)

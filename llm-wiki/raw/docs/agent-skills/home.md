...
---
> **In here:** what Agent Skills are and the SKILL.md folder format · progressive disclosure (discovery/activation/execution) · client showcase of agents/tools that support the standard

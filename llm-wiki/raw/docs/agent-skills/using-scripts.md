...
---
> **In here:** one-off commands via uvx/pipx/npx/bunx/deno/go run · self-contained scripts with inline dependencies (PEP 723, Deno, Bun, Ruby) · designing script interfaces for agentic use (non-interactive, --help, structured output)

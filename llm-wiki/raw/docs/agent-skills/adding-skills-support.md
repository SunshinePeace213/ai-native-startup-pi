...
---
> **In here:** progressive disclosure (catalog/instructions/resources tiers) · discovery, parsing, and disclosure of `SKILL.md` files · activation, structured wrapping, and context management across a session

...
author: OpenAI
---
> **In here:** reasoning effort & modes (standard/pro) · preserving reasoning across turns (context, encrypted_content) · prompting advice & phase parameter for agentic flows
...
![Reasoning tokens with current-turn context](../assets/docs/openai/reasoning-tokens-current-turn-context.png)

...
fetched: 2026-09-12
---
> **In here:** installing/updating pi packages (npm, git, local paths) · authoring a package manifest and gallery metadata · dependencies, filtering, enable/disable, and scope/dedup rules
...
- SSH URLs use your configured SSH keys automatically (respects your SSH client configuration).

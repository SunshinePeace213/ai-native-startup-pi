...
fetched: 2026-09-12
---
> **In here:** writing TypeScript extensions for pi · the full lifecycle event catalog (startup, session, agent, model, tool, bash, input) · ExtensionContext/API methods, custom tools, custom UI, and error handling

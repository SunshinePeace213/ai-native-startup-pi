...
fetched: 2026-09-12
---
> **In here:** JSONL command/event protocol for headless RPC mode · full command reference (prompting, state, model, session) · event types, extension UI sub-protocol, and message/type schemas

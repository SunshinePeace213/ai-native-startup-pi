...
fetched: 2026-09-12
---
> **In here:** auto-compaction triggers and algorithm · branch summarization on `/tree` navigation · extension hooks and settings for customizing summarization
...
"When a single turn exceeds `keepRecentTokens`, the cut point lands mid-turn at an assistant message."

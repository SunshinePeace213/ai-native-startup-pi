...
fetched: 2026-09-12
---
> **In here:** customizable key format and modifiers · full action-to-default-key reference tables (editor, TUI, sessions, models, tree nav) · custom `keybindings.json` examples (Emacs, Vim)

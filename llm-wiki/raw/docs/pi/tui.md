...
fetched: 2026-09-12
---
> **In here:** the pi-tui Component interface (render/handleInput/handleMouse/invalidate) · built-in components and theming · common extension UI patterns (SelectList, BorderedLoader, custom editor)

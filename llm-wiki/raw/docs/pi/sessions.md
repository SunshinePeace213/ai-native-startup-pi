...
fetched: 2026-09-12
---
> **In here:** session storage & JSONL format · session commands & branching with `/tree` · naming, resuming, and deleting sessions
...
![Tree View](../../assets/docs/pi/sessions-tree-view.png)

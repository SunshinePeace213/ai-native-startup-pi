...
---
> **In here:** the six-stage AI-native SDLC (Plan, Design, Build, Test, Deploy, Maintain) · committed artifacts (intent.md, spec.md, plan.md) and skills/hooks as policy · governance, CLAUDE.md, parallel sessions, and closing the maintenance loop
...
![Build is no longer the constraint — the human-speed steps around it are. Human-speed stages keep their length while build collapses to hours.](../../assets/articles/anthropic/build-no-longer-constraint.png)
...
![The AI-native SDLC as a loop, with AI embedded at each point of the six stages.](../../assets/articles/anthropic/ai-native-sdlc-loop-diagram.png)
...
![The plays listed by stage, with arrows giving the order to adopt them in.](../../assets/articles/anthropic/plays-stage-order-diagram.png)
...
![The channel is the audit trail: request, diagnosis, human authorization and fix all stay where the incident was handled.](../../assets/articles/anthropic/claude-tag-incident-channel.png)

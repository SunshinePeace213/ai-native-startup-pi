...
fetched: 2026-08-23
author: Thariq Shihipar (with Sid Bidasaria, members of technical staff at Anthropic)
last_modified: 2026-08-20
---
> **In here:** how Claude Code's dynamic workflows work · common orchestration patterns (fan-out, tournament, adversarial verification, etc.) · use cases and tips for building workflows
...
![Dynamic workflows execute a javascript file with special functions that help spawn and coordinate subagents](../../assets/articles/anthropic/dynamic-workflow-javascript-functions.png)
...
![Comparison of dynamic vs static workflows](../../assets/articles/anthropic/dynamic-vs-static-workflows.png)
...
![Common workflow patterns Claude may use and compose together](../../assets/articles/anthropic/common-workflow-patterns.png)
...
![Deep verification workflow: an agent identifies factual claims and spins off subagents to check each one](../../assets/articles/anthropic/deep-verification-workflow.png)
...
![Sorting workflow using tournaments, pairwise-comparison pipelines, or parallel bucket-ranking](../../assets/articles/anthropic/sorting-workflow.png)
...
![Memory and rule adherence workflow with one verifier agent per rule](../../assets/articles/anthropic/memory-rule-adherence-workflow.png)
...
![Triaging at scale workflow with a quarantine pattern separating agents that read untrusted content from agents that act](../../assets/articles/anthropic/triaging-at-scale-workflow.png)
...
![Saving a workflow from the workflow menu](../../assets/articles/anthropic/saving-workflows-menu.png)
...
![Sharing a workflow via a skill by referencing JavaScript workflow files in SKILL.md](../../assets/articles/anthropic/sharing-workflow-via-skill.png)
...
_For principles on what belongs in a harness in the first place, see our three_ [_harness design patterns_](https://claude.com/blog/harnessing-claudes-intelligence) _for building with Claude._

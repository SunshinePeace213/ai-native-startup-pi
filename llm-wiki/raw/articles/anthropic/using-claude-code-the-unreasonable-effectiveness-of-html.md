...
---
> **In here:** why HTML beats Markdown for Claude Code outputs · use cases (specs, code review, design, reports, custom editors) · staying in the loop with Claude's work
...
![Example HTML file illustrating information density with tables, diagrams, and rich formatting](../../assets/articles/anthropic/information-density-example.png)
...
![Example of Claude estimating colors with unicode characters in a Markdown file](../../assets/articles/anthropic/unicode-color-estimation-example.png)

## Visual clarity and ease of reading

![Example HTML document showing visual clarity with tabs and navigable structure](../../assets/articles/anthropic/visual-clarity-html-doc-example.png)
...
![Example HTML interface with sliders and knobs for two-way interaction](../../assets/articles/anthropic/two-way-interaction-sliders-example.png)
...
To make this approach more concrete, below are some [example use cases](https://thariqs.github.io/html-effectiveness/) where I think using HTML files make more sense than Markdown. You can also follow along with a GitHub gallery of these use cases, [in this repository](https://github.com/anthropics/html-effectiveness).
...
![Example HTML file used for specs, planning, and exploration of different approaches](../../assets/articles/anthropic/specs-planning-exploration-example.png)
...
![Example HTML artifact rendering a code diff with inline margin annotations for code review](../../assets/articles/anthropic/code-review-diff-annotations-example.png)
...
![Example HTML prototype with sliders for tuning a design or animation](../../assets/articles/anthropic/design-prototype-slider-example.png)
...
![Example HTML explainer report with diagrams and annotated code snippets](../../assets/articles/anthropic/reports-research-explainer-example.png)
...
![Example custom HTML editing interface, purpose-built for one data set](../../assets/articles/anthropic/custom-editing-interface-example.png)

...
---
> **In here:** the vocabulary of agent evals (tasks, graders, transcripts, harnesses) · code/model/human grader trade-offs and a step-by-step roadmap from zero to a trusted eval suite · pass@k vs pass^k, coding/conversational/research/computer-use agent patterns, and how evals fit with production monitoring, A/B tests, and human review
...
![Components of evaluations for agents.](../../assets/articles/anthropic/evals-components-of-agent-evaluations.png)
...
![pass@k and pass^k diverge as trials increase. At k=1, they're identical (both equal the per-trial success rate). By k=10, they tell opposite stories: pass@k approaches 100% while pass^k falls to 0%.](../../assets/articles/anthropic/evals-pass-at-k-vs-pass-caret-k.png)
...
![*The process of creating an effective evaluation.*](../../assets/articles/anthropic/evals-process-of-creating-an-effective-evaluation.png)
...
![Like the Swiss Cheese Model from safety engineering, no single evaluation layer catches every issue. With multiple methods combined, failures that slip through one layer are caught by another.](../../assets/articles/anthropic/evals-swiss-cheese-model-of-evaluation-methods.png)

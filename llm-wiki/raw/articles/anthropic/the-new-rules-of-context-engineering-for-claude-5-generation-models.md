...
---
> **In here:** why Anthropic simplified Claude Code's system prompt for Claude 5 models · six then-vs-now context engineering shifts · how to apply the changes to system prompts, CLAUDE.md, skills, and references
...
![Illustration of conflicting instructions like "leave documentation as appropriate" and "DO NOT add comments" clashing in a single request](../../assets/articles/anthropic/conflicting-instructions-example.png)
...
![Then and now comparison of context engineering best practices](../../assets/articles/anthropic/then-and-now-overview.png)
...
![Todo tool example showing status parameter design (pending, in_progress, completed)](../../assets/articles/anthropic/todo-tool-interface-design.png)
...
![Diagram of how context is assembled from System Prompt, CLAUDE.md, Skills, and References](../../assets/articles/anthropic/context-assembly-diagram.png)

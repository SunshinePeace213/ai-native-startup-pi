...
---
> **In here:** the seven Claude Code customization methods (CLAUDE.md, rules, skills, subagents, hooks, output styles, append-system-prompt) · a comparison table of load timing, compaction behavior, and context cost · common misuse patterns and which method to use instead.
...
![All subdirectory CLAUDE.md files below the cwd load when Claude reads a file within that directory.](../../assets/articles/anthropic/subdirectory-claude-md-loading.png)
...
![Skills are triggered via your system prompt.](../../assets/articles/anthropic/skills-triggered-via-system-prompt.png)
...
![Claude Code's context window holds everything Claude knows about your session. The interactive timeline here walks through what loads and when.](../../assets/articles/anthropic/context-window-timeline.png)
...
![A map of events in a Claude Code session when a hook can fire.](../../assets/articles/anthropic/hook-lifecycle-event-map.png)

...
---
> **In here:** the four types of unknowns (known knowns, known unknowns, unknown knowns, unknown unknowns) · pre/during/post-implementation patterns (blind spot pass, brainstorms, interviews, references, implementation plans, implementation notes, pitches, quizzes) · worked example editing the Fable launch video
...
![The map (your prompts and context) versus the territory (the codebase and real-world constraints), with the gap between them labeled your unknowns](../../assets/articles/anthropic/map-and-territory-diagram.png)
...
![Four-quadrant diagram of known knowns, known unknowns, unknown knowns, and unknown unknowns](../../assets/articles/anthropic/four-unknowns-quadrants.png)
...
![Before-and-after iceberg illustration showing unknowns above the waterline shrinking after finding your unknowns](../../assets/articles/anthropic/finding-your-unknowns-iceberg.png)

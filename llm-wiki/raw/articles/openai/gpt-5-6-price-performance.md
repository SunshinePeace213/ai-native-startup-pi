...
---
> **In here:** GPT‑5.6 Luna/Terra price cuts and Sol Fast mode · efficiency gains across models, inference, and agent harness · availability, pricing, and compute-strategy rationale

![Advancing the price-performance frontier with GPT-5.6](../../assets/articles/openai/gpt-5-6-price-performance-hero.png)
...
*(Customers cited: Replit, Notion, Ramp, Blitzy, Cognition, Dust)*
